                                                                                                                                    ...
                                                                                                                                    GameState->TransientArena = SubMemoryArena(&GameState->MemoryArena, MegaBytes(2));
                                                                                                                                    ...
                                                                                                                                    GameState->Player = InitEntity(GameState, V2(10, 10), 0.3f*V2(WorldChunkInMeters, WorldChunkInMeters), Entity_Player);
                                                                                                                                    ...
                                                                                                                                    entity *House = InitEntity(GameState, V2(15, 10), V2(WorldChunkInMeters, WorldChunkInMeters), Entity_Home, false);
                                                                                                                                    House->InverseWeight = 0;
                                                                                                                                    
                                                                                                                                    GameState->DayLightTimer.Period = 60.0f;
